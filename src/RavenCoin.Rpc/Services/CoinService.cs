...
namespace RavenCoin.Rpc.Services
{
    public partial class CoinService : ICoinService
    {
        ...
        //public string DumpPrivKey(string ravencoinAddress)
        //{
        //    return _rpcConnector.MakeRequest<string>(RpcMethods.dumpprivkey, ravencoinAddress);
        //}
        ...
        //public string GetAccount(string ravencoinaddress)
        //{
        //    return _rpcConnector.MakeRequest<string>(RpcMethods.getaccount, ravencoinaddress);
        //}
        ...
        //public GetAddressInfoResponse GetAddressInfo(string ravencoinaddress)
        //{
        //    return _rpcConnector.MakeRequest<GetAddressInfoResponse>(RpcMethods.getaddressinfo, ravencoinaddress);
        //}
        ...
        //public decimal GetReceivedByAddress(string ravencoinaddress, int minConf)
        //{
        //    return _rpcConnector.MakeRequest<decimal>(RpcMethods.getreceivedbyaddress, ravencoinaddress, minConf);
        //}

        //public decimal GetReceivedByLabel(string ravencoinaddress, int minConf)
        //{
        //    return _rpcConnector.MakeRequest<decimal>(RpcMethods.getreceivedbylabel, ravencoinaddress, minConf);
        //}
        ...
        //public string SendFrom(string fromAccount, string toravencoinaddress, decimal amount, int minConf, string comment, string commentTo)
        //{
        //    return _rpcConnector.MakeRequest<string>(RpcMethods.sendfrom, fromAccount, toravencoinaddress, amount, minConf, comment, commentTo);
        //}

        //public string SendMany(string fromAccount, Dictionary<string, decimal> toravencoinaddress, int minConf, string comment)
        //{
        //    return _rpcConnector.MakeRequest<string>(RpcMethods.sendmany, fromAccount, toravencoinaddress, minConf, comment);
        //}
        ...
        //public string SendToAddress(string ravencoinaddress, decimal amount, string comment, string commentTo, bool subtractFeeFromAmount)
        //{
        //    return _rpcConnector.MakeRequest<string>(RpcMethods.sendtoaddress, ravencoinaddress, amount, comment, commentTo, subtractFeeFromAmount);
        //}

        //public string SetAccount(string ravencoinaddress, string account)
        //{
        //    return _rpcConnector.MakeRequest<string>(RpcMethods.setaccount, ravencoinaddress, account);
        //}

        //public string SetLabel(string ravencoinaddress, string label)
        //{
        //    return _rpcConnector.MakeRequest<string>(RpcMethods.setlabel, ravencoinaddress, label);
        //}
        ...
        //public string SignMessage(string ravencoinaddress, string message)
        //{
        //    return _rpcConnector.MakeRequest<string>(RpcMethods.signmessage, ravencoinaddress, message);
        //}
        ...
        //public ValidateAddressResponse ValidateAddress(string ravencoinaddress)
        //{
        //    return _rpcConnector.MakeRequest<ValidateAddressResponse>(RpcMethods.validateaddress, ravencoinaddress);
        //}
        ...
        //public bool VerifyMessage(string ravencoinaddress, string signature, string message)
        //{
        //    return _rpcConnector.MakeRequest<bool>(RpcMethods.verifymessage, ravencoinaddress, signature, message);
        //}
